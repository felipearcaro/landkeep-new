...
export default function SecureLoan() {
  const loan = useLoaderData<Loan>();
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <ul role="list" className="divide-y divide-gray-200">
                  <li key={loan.id} className="flex py-6 px-4 sm:px-6">
                    ...
                    <div className="ml-6 flex-1 flex flex-col">
                      <div className="flex">
                        <div className="min-w-0 flex-1">
                          <h4 className="text-md font-medium">{loan.name}</h4>
                          <p className="mt-1 text-sm text-gray-500">
                            {loan.county} County, {loan.state}
                          </p>
                          <p className="mt-1 text-sm text-gray-500">
                            {loan.arn}
                          </p>
                ...
                <dl className="border-t border-gray-200 py-6 px-4 space-y-6 sm:px-6">
                  <div className="flex items-center justify-between">
                    <dt className="text-sm">Down Payment</dt>
                    <dd className="text-sm font-medium text-gray-900">
                      {toUSD(loan.downPayment)}
                    </dd>
                  </div>
                  <div className="flex items-center justify-between">
                    <dt className="text-sm">Processing Fee</dt>
                    <dd className="text-sm font-medium text-gray-900">
                      {toUSD(loan.processingFee)}
                    </dd>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                    ...
                    <dd className="text-base font-medium text-gray-900">
                      {toUSD(
                        Number(loan.downPayment) + Number(loan.processingFee)
                      )}
                    </dd>
                  </div>
                </dl>
